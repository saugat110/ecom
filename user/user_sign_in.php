            ...
            <div class="col-10 col-sm-9 col-md-8 col-lg-6 ps-5">
                <form action="user_data_entry.php" method="post">
                    ...
                    <?php if(!isset($_GET['dup'])) { ?>
                        ...
                        <input type="text" class="form-control" name="name" id="i1" required>
                    <?php }  else { ?>
                        <label for="i1" class="form-label mt-1">Enter Name:</label>
                        <input type="text" class="form-control is-invalid" name="name" id="i1" required>
                    ...
                    <input type="text" class="form-control" name="address" id="i4" required>

                    <label for="i5" class="form-label mt-1">Enter phone:</label>
                    <input type="text" class="form-control" name="phone" id="i5" required>
